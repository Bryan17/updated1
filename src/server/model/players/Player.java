...
public abstract class Player {
	...
	public static final int[] ARROWS = {882,884,886,888,890,892,4740,11212,9140,9141,4142,9143,9144,9240,9241,9242,9243,9244,9245};
	public static final int[] BOWS = 	{9185,839,845,847,851,855,859,841,843,849,853,857,861,4212,4214,4215,11235,4216,4217,4218,4219,4220,4221,4222,4223,6724,4734,4934,4935,4936,4937};
...
/*End of curse prayers*/
	...
	public boolean isInPvP() {		
		if(absX >= 3162 && absX <= 3287 && absY >= 3355 && absY <= 3511) {
			return true;
		}
		return false;
	}
	public boolean isInBank() {		
		if(absX >= 3180 && absX <= 3190 && absY >= 3433 && absY <= 3447) {
			return true;
		}
		return false;
	}
