...
public class CombatAssistant{
	...
	public int[][] slayerReqs = {{1648,1},{1612,15},{1643,45},{1618,50},{1624,65},{1610,75},{1613,80},{1615,85},{2783,90}};
	...
	**/
		...
		public void attackPlayer(final int i) {
			...
			Client e2 = (Client)Server.playerHandler.players[i];
			if(c.combatTimer >= 0 && !c.isInBank() && !e2.isInBank()) {
				c.combatTimer = 10;
				e2.combatTimer = 10;
			}
			...
			if(c.curseActive[10]) { // LeechPrayer
				c.getatt = Server.playerHandler.players[i].playerLevel[0] * 10 / 100;
			}
	...
	public int getWeaponDistance(String weaponName) {
		...
		if(weaponName.contains("thrownaxe") || c.playerEquipment[c.playerWeapon] == 15016){
			if(c.fightMode == 3) {
				return 6;
			} else {
				return 4;
		...
		if(weaponName.contains("javelin") || c.playerEquipment[c.playerWeapon] == 15015){
			if(c.fightMode == 3) {
				return 7;
			} else {
				return 5;
	...
	public void activateSpecial(int weapon, int i){
		...
		switch(weapon) {
			...
			break;
				...
				case 15016: // Morrigan throwing axe
					c.usingRangeWeapon = true;
				c.rangeItemUsed = c.playerEquipment[c.playerWeapon];
				c.getItems().deleteArrow();
				c.lastWeaponUsed = weapon;
 ...
 if(weaponName.contains("2h sword") || weaponName.contains("godsword") || weaponName.contains("saradomin sw")) {
	...
	**/
	...
	/*public int rangeMaxHit() {
        ...
        } else if (weapon == 15015) {
	    rangehit = 10;
	    rangehit += c.playerLevel[4] / 17;
        } else if (weapon == 15016) {
	    rangehit = 7;
	    rangehit += c.playerLevel[4] / 17;
