...
public class CombatAssistant{
	...
	public void fireProjectileNpc() {
		if(c.oldNpcIndex > 0) {
			if(Server.npcHandler.npcs[c.oldNpcIndex] != null) {
				...
				if (usingDFS())
					c.getPA().createPlayersProjectile(pX, pY, offX, offY, 50, getProjectileSpeed(), getRangeProjectileGFX1(), 43, 31, c.oldNpcIndex + 1, getStartDelay());
				else if (usingDbow())
	...
	**/
	...
	public boolean usingDFS() {
		return c.playerEquipment[c.playerShield] == 11284;
	}
	...
	**/
	...
	public int getRangeProjectileGFX1() {
		if(c.playerEquipment[c.playerShield] == 11284) {
			return 1166;
		}
		return -1;
	}
	public int getRangeStartGFX1() {
		if(c.playerEquipment[c.playerShield] == 11284) {
			return 1165;
		}
		return -1;
	...
	**/
	...
	public void handleDfs() {
		if (System.currentTimeMillis() - c.dfsDelay > 30000) {
			...
			c.sendMessage("The shield must be given time to cool down after using such an attack!");
		}
	}
